...
class TestBalanceWithHistoryAndStrategy(unittest.TestCase):
    def setUp(self):
        ...
        self.balance = BalanceWithHistoryAndStrategy(
            self.initial_amount, self.start_date, self.strategy
        )
    ...
    def test_initialization(self):
        ...
        self.assertEqual(
            self.balance.history(), [(self.start_date, self.initial_amount)]
        )
    ...
    def test_large_growth_rate(self):
        ...
        balance = BalanceWithHistoryAndStrategy(
            self.initial_amount, self.start_date, high_growth_strategy
        )
